...
public class ObjMetodo {
	...
	public ObjMetodo(String nome){
		...
		this.mappaArchi=new HashMap<String, ArrayList<String>>();
		this.mappaChiamate=new HashMap<String, ArrayList<String>>();
		this.mappaChiamateLette=new HashMap<String, Boolean>();
	...
	public void inserisciMappaChiamate(){
		for(String id_chiamante : mappaArchi.keySet()){
			...
			ArrayList<String> nomi_chiamati = new ArrayList<String>();
